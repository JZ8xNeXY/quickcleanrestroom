...
ActiveRecord::Schema[7.0].define(version: 2024_05_11_222031) do
  ...
  create_table "facilities", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.boolean "anyone_toilet"
    t.boolean "diaper_changing_station"
    t.boolean "powder_corner"
    t.boolean "stroller_accessible"
  end
